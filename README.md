...
- [외근][보수 및 추가][외근신청보수 및 사용자 외근신청내역 리스트 추가]_otj




### 2024-01-22
- [외근][보수 및 추가][사용자외근리스트 오류수정 및 관리자외근리스트 추가]_otj
  1. 외근 승인 / 반려 백엔드로직 필요 (js수정필요 )

### 2024-01-23
- [외근][추가][외근신청 관자승인 및 반려 로직추가 ]_otj
...
### 2024-01-24
- [연차][추가][나의 연차리스트 화면반환 로직추가]_otj
  1. 연차리스트 html 화면 디자인작업 필요
  


### 2024-01-28
- [연차][추가][나의 연차리스트 화면 추가]_otj
  1. 연차리스트 Html , CSS 추가 
